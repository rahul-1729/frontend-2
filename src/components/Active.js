...
function Active() {
  ...
  return (
    <div className='h-full w-full flex items-center justify-between px-3'>
           <div className='h-full w-2/7 flex items-center relative' >
              <img  className=' w-14 h-14 rounded-full border border-indigo-700' src= {user0} alt={user0} />
              <span class="bottom-4 left-10 absolute  w-3.5 h-3.5 bg-indigo-700 border border-white   rounded-full"></span>
           </div>
